...
-- local install_path = require("mason-registry").get_package("jdtls"):get_install_path()
-- local install_path = require("mason-registry").get_installed_packages()

local install_path = "/Users/guo/.local/share/nvim/mason/packages/jdtls/jdtls"

-- vim.notify("install_path" .. install_path)
