        ...
        opts = {
            ...
            status = {
                ...
                colors = function(hl)
                    ...
                    -- hl.mini_tabline_tab_page_section_bg = hl.bg
                    -- hl.tabline_tabpage_section_bg = hl.bg
                    hl.tab_icon_bg = hl.bg
                    -- hl.tabline_fill_bg = hl.nav_fg
                    -- hl.tabline_sel_bg = hl.nav_fg
                    ...
                    hl.buffer_overflow_bg = hl.bg -- tabline right left button

                    hl.tab_close_bg = hl.nav_fg
                    -- hl.title_fg = hl.file_info_bg
        ...
        opts = function(_, opts)
            ...
            opts.statusline = {
                ...
                status.component.git_branch {
                    git_branch = { padding = { left = 2, right = 1 } },
                ...
                { -- make nav section with icon border
                    ...
                    status.component.builder {
                        ...
                        surround = {
                            ...
                            -- color = { main = "bg", left = "file_info_bg" },
                        },
                    },
